...
public class OrderDAOImpl implements OrderDAO{
	...
	private void decreaseUserBalance(Connection con, PreparedStatement ps, User user) throws SQLException {
		///возможно перенести в userDAO и оформлять как транзакцию в сервис слое
	...
	private Order compileGetOrderQuery(Connection con, PreparedStatement ps, Order order) throws DAOException, SQLException {
		Order result = null;
