...
public class QueryList {
    ...
    public static final String GetUserQuery = "SELECT `c`.`c_id`, `c_name`, `c_surname`,`c_email`,`c_password`,`c_phonenumber`,`c_isbanned`,`is_admin`,`discount_coefficient`,`c_balance` "
                                	    + "FROM `online_shop`.`clients` as `c` " 
                                	    + "LEFT JOIN `online_shop`.`discounts` as `d` "
                                	    + "ON  `c`.`c_id` = `d`.`c_id` ";

    public static final String GetUserQueryLogin_P = "WHERE `c_email`=? && `c_password`=?;";
    public static final String GetUserQueryId_P = "WHERE `c`.`c_id`=?;";
    ...
    public static final String DeleteUserQuery = "UPDATE `online_shop`.`orders` "
                                	       + "SET `o_deleted`=true "
                                	       + "WHERE o_id=?; ";
    ...
    public static final String GetAllOrdersQuery = "SELECT `o_id`, `c_id`, `o_order_date`,`o_delivery_date`, `o_address`,`o_bill`,`o_ispaid`,`o_iscompleted`,`o_deleted` "
	    					 + "FROM `online_shop`.`orders` "
	    					 + "WHERE `o_deleted`=false; ";

    public static final String GetOrderQuery_P = "SELECT `o_id`, `c_id`, `o_order_date`,`o_delivery_date`, `o_address`,`o_bill`,`o_ispaid`,`o_iscompleted` "
