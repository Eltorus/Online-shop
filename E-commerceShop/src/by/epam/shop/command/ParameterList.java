...
public final class ParameterList {
    ...
    public static final String PRODUCT_INDX = "product_index";

    public final static String ORDER_ADDRESS = "address";
    public final static String ORDER_DELIVERY_DATE = "delivery_date";
    public final static String ORDER_ID = "order_id";
    public final static String ORDER_IS_COMPLITED = "isOrderComplited";
    public final static String ORDER_COMPLITED = "Complited";
}
